...
const allowedSender = '923228979788@s.whatsapp.net';
if (m.chat === specificGroup && m.sender !== allowedSender) {
	...
	//if (m.chat !== '120363032639627036@g.us') return
       // if (m.chat === '120363032639627036@g.us' && m.sender !== '923228979788@s.whatsapp.net') return;
...
if (
  ...
  if (m.text.match(/(TECH-GR-BOT|a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z)/gi)) {
    ...
    this.sendMessage(m.chat, {
      react: {
        text: (m.sender === '923228979788@s.whatsapp.net') ? "👑" : pickRandom(emojis),
        key: m.key
      }
    });
  }
